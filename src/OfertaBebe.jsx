...
import nacimientoBg from './assets/nacimiento.png';
// --- Datos del Escenario Hipotecario ---
const scenario = {
  id: "nacimiento",
  step1: {
    h1: "¡Felicitaciones, papá! Se viene una gran aventura 💛",
    p: "Queremos acompañarte en este momento único. Por eso, el banco te regala <span class='highlight'>$1.500.000</span> para que empieces a preparar todo para la llegada de tu bebé: pañales, ropita y mucho amor.",
    cta: "Recibir mi regalo",
  },
  step2: {
    h1: "Estás a un paso de hacerlo realidad",
    p: "Confirmá tu solicitud y en menos de 24 hs hábiles vas a tener el dinero en tu cuenta, listo para usar cuando más lo necesites.",
    cta: "Quiero recibirlo",
    subtext: "Acreditación inmediata",
  },
  backgroundImage: nacimientoBg
};
